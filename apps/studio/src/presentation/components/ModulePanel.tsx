...
export const PRESETS: MacroPreset[] = [
  ...
  },
  {
    ...
    tooltip: "Compresión pesada (5:1) con boost de transientes +3dB y saturación leve. El limitador empuja a -9 LUFS para ese punch que domina en trap y drill. Cuidado con mezclas ya comprimidas.",
    icon: Flame,
    params: {
      ...DEFAULT_PARAMS,
  ...
  },
  {
    ...
    tooltip: "Compresión extrema (8:1) con saturación pesada (+4dB) y limitador al borde (-0.1dB). Transientes +4dB para que el dembow y el reggaeton golpeen como muro. El preset más agresivo — úsalo con cabeza.",
    icon: Zap,
    params: {
      ...DEFAULT_PARAMS,
